    ...
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-white">Geographic Filter</h3>
        </div>
        ...
        <div className="flex items-center gap-1.5 mb-3 text-xs">
          ...
          {selectedRegion && (
            <>
              ...
              <span className="bg-purple-500/10 text-purple-400 px-2 py-1 rounded-md font-medium">
                {selectedRegion}
              </span>
            </>
          )}
                    ...
                    {country.children.map((region) => (
                      ...
                      >
                        <span className="flex items-center gap-2">
                          ...
                          {region.name}
                          <span className="text-slate-600 capitalize">({region.type})</span>
                        </span>
                      </button>
                    ))}
                  </div>
