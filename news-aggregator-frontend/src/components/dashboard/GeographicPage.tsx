        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          {regionStats && (
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              className="glass-card rounded p-5 space-y-3"
            >
        ...
        <div className="lg:col-span-3">
          {filteredNews.length > 0 ? (
            ...
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="glass-card rounded p-12 flex flex-col items-center justify-center text-center"
            >
              <MapPin className="w-12 h-12 text-gray-300 mb-4" />
              <h3 className="text-lg font-semibold text-gray-500 mb-2">No trends found</h3>
